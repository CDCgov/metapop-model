...
def test_get_helpers():
    ...
    expected_r0 = r"The basic reproductive number captures contact rates and the probability of infection given contact with an infectious individual. Some communities may have different contact patterns — for example, in communities with larger households or higher population density. $R_0$ values for measles are typically estimated to be between 12 and 18 (see Detailed Methods)"
    assert (
