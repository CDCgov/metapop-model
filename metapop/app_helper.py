...
def get_helpers(parms=None):
    ...
    defaults = dict(
        ...
        symptomatic_isolation_start_day="Number of days after introduction until the isolation intervention starts. Defaults to 4 days or day 5 in the model (when introduced infections have first rash onset on average with an infectious period of 9 days). Isolation intervention can start up to 180 days or approximately 6 months after introduction of measles into the community.",
        ...
        pre_rash_isolation_start_day="Number of days after introduction until the quarantine intervention starts. Only used if quarantine is turned on. Defaults to 4 days or day 5 in the model (when introduced infections have first rash onset on average with an infectious period of 9 days). Quarantine intervention can start up to 180 days or approximately 6 months after introduction of measles into the community.",
