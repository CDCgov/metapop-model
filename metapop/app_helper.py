...
def get_helpers(parms=None):
    ...
    defaults = dict(
        ...
        vaccine_uptake_start_day="Number of days after introduction that the vaccination campaign starts (0 days is the day infections are imported to the community).",
