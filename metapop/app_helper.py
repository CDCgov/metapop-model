...
def get_helpers(parms=None):
    ...
    defaults = dict(
        ...
        vaccine_uptake_start_day="Number of days after introduction until the vaccination campaign starts (for example, 4.5 days corresponds to day 6 in the model when introduced infections have rash onset, on average). Defaults to 5 days (~4.5 days when introduced infections have rash onset on average with an infectious period of 9 days). Vaccination campaigns can start up to 180 days or approximately 6 months after introduction of measles into the community.",
        ...
        symptomatic_isolation_start_day="Number of days after introduction until the isolation intervention starts (for example, 4.5 days corresponds to day 6 in the model when introduced infections have rash onset, on average). Defaults to 5 days (~4.5 days when introduced infections have rash onset on average with an infectious period of 9 days). Isolation intervention can start up to 180 days or approximately 6 months after introduction of measles into the community.",
        ...
        pre_rash_isolation_start_day="Number of days after introduction until the quarantine intervention starts (for example, 4.5 days corresponds to day 6 in the model when introduced infections have rash onset, on average). Only used if quarantine is turned on. Defaults to 5 days (~4.5 days when introduced infections have rash onset on average with an infectious period of 9 days). Quarantine intervention can start up to 180 days or approximately 6 months after introduction of measles into the community.",
