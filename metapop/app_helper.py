...
def get_helpers(parms=None):
    ...
    defaults = dict(
        ...
        vaccine_uptake_start_day="Number of days after introduction until the vaccination campaign starts (for example, 4.5 days corresponds to day 6 in the model when introduced infections have rash onset, on average). Defaults to 5 days (when introduced infections have rash onset on average). Vaccination campaigns can start up to 180 days or approximately 6 months after introduction of measles into the community.",
        ...
        symptomatic_isolation_start_day="Number of days after introduction until the isolation intervention starts (for example, 4.5 days corresponds to day 6 in the model when introduced infections have rash onset, on average). Defaults to 5 days (when introduced infections have rash onset on average). Isolation intervention can start up to 180 days or approximately 6 months after introduction of measles into the community.",
