...
def app(replicates=20):
    ...
    with st.sidebar:
        st.markdown(
            "This simulator is designed for use in the early stages of an "
            "outbreak to understand the potential impact of isolation, "
            "quarantine, and vaccination on the size of a measles outbreak "
            "and is most applicable at the county level or smaller geographic "
