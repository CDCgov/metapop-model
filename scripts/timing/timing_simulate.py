...
if __name__ == "__main__":
    ...
    parameter_sets = griddler.griddle.read("scripts/timing/timing_config.yaml")

    for params in parameter_sets:
        scenario = params.get("intervention_scenario")
        delay = params.get("intervention_delay")

        params["vaccine_uptake_start_day"] = delay
        params["symptomatic_isolation_start_day"] = delay
        params["pre_rash_isolation_start_day"] = delay
