...
def get_helpers(parms=None):
    ...
    defaults = dict(
        ...
        symptomatic_isolation_start_day="Number of days after introduction until the isolation intervention starts (for example, 4 days corresponds to day 5 in the model when introduced infections have rash onset, on average). Defaults to 4 days (when introduced infections have rash onset on average).",
